...
$works = [
    [
        ...
        "description" => "Описание: Просто отдыхал от суеты.",
    ],
    [
        "name" => "Специалист по Поддержке ПО",
        "dateStart" => "Сентябрь 2008",
        "dateEnd" => "Январь 2014",
        "description" => "Описание: Чинил компьютеры, пока это было не модно",
    ],
    [
        "name" => "Оператор ЭВМ",
        "dateStart" => "Январь 2002",
        "dateEnd" => "Январь 2008",
        "description" => "Описание: Ломал компьютеры, пока это было не модно",
    ],
    ];
?>
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        <h2 class="w3-text-grey w3-padding-16"><i class="f a fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Опыт работы</h2>
